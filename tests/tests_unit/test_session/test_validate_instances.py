...
class TestValidateInstancesAPI:
        ...
        return [
            {
                ...
                "space": "test_space",
                "properties": {"test_space": {"Asset/v1": {"name": "Test Asset"}}},
            }
        ]
    ...
    def test_add_instance_to_graph_creates_triples(self, api):
        ...
        instance = {
            "externalId": "asset-001",
            "space": "test_space",
            "properties": {"test_space": {"Asset/v1": {"name": "Test Asset", "value": 42}}},
        }
    ...
    def test_add_instance_to_graph_handles_direct_relations(self, api):
        ...
        instance = {
            ...
            "space": "test_space",
            "properties": {"test_space": {"Order/v1": {"asset": {"externalId": "asset-001", "space": "test_space"}}}},
        }
    ...
    def test_add_instance_to_graph_handles_list_of_literals(self, api):
        ...
        instance = {
            "externalId": "asset-001",
            "space": "test_space",
            "properties": {"test_space": {"Asset/v1": {"tags": ["tag1", "tag2", "tag3"]}}},
        }
    ...
    def test_add_instance_to_graph_skips_empty_external_id(self, api):
        ...
        instance = {"space": "test_space", "properties": {}}
